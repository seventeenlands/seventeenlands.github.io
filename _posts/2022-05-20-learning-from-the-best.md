...
| --- | --- | --- | --- |
| <scryfall-card>Run Out of Town</scryfall-card> | 0.279 | 0.438 | 0.158 |
| <scryfall-card>Make Disappear</scryfall-card> | 0.233 | 0.357 | 0.124 |
| <scryfall-card>Raffine's Informant</scryfall-card> | 0.459 | 0.579 | 0.120 |
| <scryfall-card>Majestic Metamorphosis</scryfall-card> | 0.301 | 0.411 | 0.109 |
| <scryfall-card>Girder Goons</scryfall-card> | 0.371 | 0.474 | 0.102 |
| <scryfall-card>Inspiring Overseer</scryfall-card> | 0.446 | 0.520 | 0.073 |
| <scryfall-card>Expendable Lackey</scryfall-card> | 0.302 | 0.374 | 0.072 |
| <scryfall-card>Brokers Hideout</scryfall-card> | 0.397 | 0.464 | 0.067 |
| <scryfall-card>Backup Agent</scryfall-card> | 0.370 | 0.437 | 0.067 |
| <scryfall-card>Gathering Throng</scryfall-card> | 0.279 | 0.345 | 0.065 |
...
| Card | Play Rate (All) | Play Rate (Top) | Δ Play Rate (Top-All) |
| --- | --- | --- | --- |
| <scryfall-card>Kill Shot</scryfall-card> | 0.159 | 0.099 | -0.059 |
| <scryfall-card>Midnight Assassin</scryfall-card> | 0.115 | 0.058 | -0.057 |
| <scryfall-card>Obscura Initiate</scryfall-card> | 0.187 | 0.130 | -0.056 |
| <scryfall-card>Riveteers Initiate</scryfall-card> | 0.144 | 0.091 | -0.053 |
| <scryfall-card>Celebrity Fencer</scryfall-card> | 0.118 | 0.066 | -0.051 |
| <scryfall-card>Witness Protection</scryfall-card> | 0.112 | 0.065 | -0.047 |
| <scryfall-card>Prizefight</scryfall-card> | 0.190 | 0.145 | -0.044 |
| <scryfall-card>High-Rise Sawjack</scryfall-card> | 0.124 | 0.081 | -0.042 |
| <scryfall-card>Deal Gone Bad</scryfall-card> | 0.196 | 0.155 | -0.041 |
| <scryfall-card>Glittermonger</scryfall-card> | 0.099 | 0.058 | -0.041 |
...
| --- | --- | --- | --- | --- |
| <scryfall-card>Goldhound</scryfall-card> | 0.128 | 0.092 | -0.036 | 8.5 percentage points |
| <scryfall-card>High-Rise Sawjack</scryfall-card> | 0.124 | 0.081 | -0.042 | 7.1 pp |
| <scryfall-card>Celebrity Fencer</scryfall-card> | 0.118 | 0.066 | -0.051 | 6.5 pp |
| <scryfall-card>Witty Roastmaster</scryfall-card> | 0.159 | 0.123 | -0.035 | 6.2 pp |
| <scryfall-card>Midnight Assassin</scryfall-card> | 0.115 | 0.058 | -0.057 | 6.2 pp |
| <scryfall-card>Shattered Seraph</scryfall-card> | 0.149 | 0.124 | -0.025 | 6.1 pp |
| <scryfall-card>Wrecking Crew</scryfall-card> | 0.104 | 0.079 | -0.024 | 5.8 pp |
| <scryfall-card>Kill Shot</scryfall-card> | 0.159 | 0.099 | -0.059 | 5.8 pp |
| <scryfall-card>Prizefight</scryfall-card> | 0.190 | 0.145 | -0.044 | 5.7 pp |
| <scryfall-card>Witness Protection</scryfall-card> | 0.112 | 0.065 | -0.047 | 5.7 pp |

Here are some thoughts on why they're able to overperform with some of these situational cards:

<ul>
  <li><scryfall-card>Goldhound</scryfall-card> is an inherently weak card, but it does a lot of small things in synergy with treasures-matter, sacrifice-matters, pump spells to 2-1 with first strike/menace, and also fixes and ramps. None of those things individually makes it worth playing a 1/1, but the best players are finding the right spots where the payoff is “good enough”.</li>
  <li><scryfall-card>Celebrity Fencer</scryfall-card> doesn’t do as much as other white 4 drops, but can be a fine finisher in a deck that stabilizes and has tons of token producers. The best players know to cut it from all but the most synergistic decks.</li>
  <li><scryfall-card>High-Rise Sawjack</scryfall-card> and <scryfall-card>Wrecking Crew</scryfall-card> are other examples of cards that more controlling decks with top end are probably fine playing, but you want to avoid most of the time.</li>
  <li><scryfall-card>Prizefight</scryfall-card> can be extremely weak in decks without high toughness spells or treasure synergies.</li>
</ul>
...
| Card | Play Rate (All) | Play Rate (Top) | Δ Play Rate (Top-All) | Δ GIH WR (Top-All) |
| --- | --- | --- | --- | --- |
| <scryfall-card>Goldhound</scryfall-card> | 0.128 | 0.092 | -0.036 | 8.5 pp |
| <scryfall-card>Tavern Swindler</scryfall-card> | 0.016 | 0.013 | -0.003 | 8.3 pp |
| <scryfall-card>Torch Breath</scryfall-card> | 0.080 | 0.062 | -0.017 | 8.2 pp |
| <scryfall-card>Angelic Observer</scryfall-card> | 0.048 | 0.031 | -0.016 | 7.9 pp |
| <scryfall-card>Scuttling Butler</scryfall-card> | 0.021 | 0.016 | -0.005 | 7.4 pp |
| <scryfall-card>High-Rise Sawjack</scryfall-card> | 0.124 | 0.081 | -0.042 | 7.1 pp |
| <scryfall-card>Tainted Indulgence</scryfall-card> | 0.059 | 0.063 | +0.004 | 7.1 pp |
| <scryfall-card>Chrome Cat</scryfall-card> | 0.039 | 0.039 | +0.000 | 7.0 pp |
| <scryfall-card>Refuse to Yield</scryfall-card> | 0.023 | 0.019 | -0.003 | 6.6 pp |
| <scryfall-card>Psionic Snoop</scryfall-card> | 0.076 | 0.079 | +0.003 | 6.5 pp |

What’s my theory on why top players get more out of some of these cards?

<ul>
  <li>Talking about <scryfall-card>Goldhound</scryfall-card> again! Ok instead of talking about when to play it, let’s talk about how to play it. It’s a sneakily difficult card to play. In particular, there are likely going to come a few critical turns when it may (or may not) be correct to sac it to ramp into a spell. Best players are making better decisions on these key turns.</li>
  <li><scryfall-card>Tavern Swindler</scryfall-card> is a big LOL for me (Carl), in that Garrett Gardner and I just released [an entire podcast about this card](https://mysticaldispute.com/episode/045-mystical-dispute-tavern-swindler-snc/). In it, we believe that players are likely just activating the ability too often, and probably are not just relying on it as a 2/2 body often enough.</li>
  <li><scryfall-card>Angelic Observer</scryfall-card> needs a TON of support before the card is playable. My guess is most of this win rate differential is deck building.</li>
  <li><scryfall-card>Chrome Cat</scryfall-card>? It’s a metal cat. Very dense. I don’t know. Scrying is hard?</li>
  <li><scryfall-card>Refuse to Yield</scryfall-card> always has the obvious play of untapping your creature and blocking to kill something, but it can be tricky to set up at times, and the best players probably have a better sense of when it’s worth the risk of getting blown out by instant speed removal.</li>
</ul>
